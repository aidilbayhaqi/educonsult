      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-28">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-4 py-1.5 text-xs font-medium text-blue-700 backdrop-blur">
            ...
            Konsultan Pendidikan #1 untuk Mahasiswa Indonesia
          </div>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-gray-600">
            Layanan konsultasi pendidikan universitas terlengkap:
            rekomendasi kampus terbaik, jalur RPL, bimbingan skripsi,
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <a
              href="#kontak"
              className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            >
            ...
            <div className="flex items-center gap-2">
              <span className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <span
                    key={i}
                    className="h-6 w-6 rounded-full border-2 border-white bg-gradient-to-r from-blue-600 to-blue-800"
                  />
                ))}
              </span>

              <span>
                <b className="text-gray-900">5.000+</b> mahasiswa terbantu
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          {/* Glow */}
          <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-blue-600 to-blue-800 opacity-20 blur-2xl" />

          {/* Main Image */}
          <div className="relative overflow-hidden rounded-3xl border border-white/60 shadow-2xl">
            <Image
              src={'/hero-student.jpg'}
              alt="Mahasiswa Indonesia konsultasi pendidikan universitas"
              width={1024}
              height={1024}
          ...
          {/* Floating Card Right */}
          <div className="absolute -right-4 top-8 hidden rounded-2xl border border-gray-200 bg-white p-4 shadow-xl sm:block">
            <div className="text-3xl font-bold text-blue-600">
              200+
            </div>
